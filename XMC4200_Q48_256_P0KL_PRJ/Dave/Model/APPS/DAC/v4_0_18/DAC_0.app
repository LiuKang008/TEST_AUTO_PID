...
<ResourceModel:App xmi:version="2.0" xmlns:xmi="http://www.omg.org/XMI" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:ResourceModel="http://www.infineon.com/Davex/Resource.ecore" name="DAC" URI="http://resources/4.0.18/app/DAC/0" description="Generates Pattern, Noise and Ramp waveform.&#xA; It can be used for single value and data processing modes." mode="NOTSHARABLE" version="4.0.18" minDaveVersion="4.0.0" instanceLabel="DAC_0" appLabel="">
  ...
  <virtualSignals name="pad_signal" URI="http://resources/4.0.18/app/DAC/0/vs_io_pad" hwSignal="pad" hwResource="//@hwResources.1"/>
  ...
  <requiredApps URI="http://resources/4.0.18/app/DAC/0/appres_analog_io" requiredAppName="ANALOG_IO" required="false" requiringMode="SHARABLE"/>
  ...
  <hwResources name="Pin" URI="http://resources/4.0.18/app/DAC/0/hwres_dac_analogpin" resourceGroupUri="port/p/sv0/pad/*" solverVariable="true" mResGrpUri="port/p/sv0/pad/*">
  ...
  <hwResources name="Pin" URI="http://resources/4.0.18/app/DAC/0/__pin_hwres_dac_analogpin" resourceGroupUri="devicepackage/0/20" constraintType="GLOBAL_RESOURCE" mResGrpUri="devicepackage/0/*">
    <downwardMapList xsi:type="ResourceModel:ResourceGroup" href="../../../HW_RESOURCES/DEVICEPACKAGE/DEVICEPACKAGE_0.dd#//@provided.2"/>
  </hwResources>
  <connections URI="http://resources/4.0.18/app/DAC/0/http://resources/4.0.18/app/DAC/0/vs_dac_output/http://resources/4.0.18/app/DAC/0/vs_io_pad" systemDefined="true" sourceSignal="analog_ch_output" targetSignal="pad_signal" srcVirtualSignal="//@virtualSignals.0" targetVirtualSignal="//@virtualSignals.4"/>
  <connections URI="http://resources/4.0.18/app/DAC/0/http://resources/4.0.18/app/DAC/0/vs_dac_output/http://resources/4.0.18/app/DAC/0/vsra_analog_io_pin" systemDefined="true" sourceSignal="analog_ch_output" required="false" srcVirtualSignal="//@virtualSignals.0" containingProxySignal="true"/>
